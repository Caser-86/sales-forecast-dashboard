...
- 下一目标为本地完整演示版 V2，M1/T1、M1/T2 共享壳、T3/T4/T5 第一切片、T6 预测分析第一切片、T7 库存试算第一切片、T8 本地角色审批第一切片和 T9 场景/恢复第一切片已完成，详细路线和证据见 [`docs/local-demo-plan.md`](docs/local-demo-plan.md) 与 [`docs/local-demo-v2-acceptance-2026-09-22.md`](docs/local-demo-v2-acceptance-2026-09-22.md)。
...
1. 补齐 T3/T5 全量训练失败恢复与模型发布浏览器 E2E。
