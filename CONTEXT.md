...
当前处于本地完整演示版 V2 执行阶段。M1/T1、M1/T2 共享壳和 T3 任务后端第一切片已完成；训练期间总览并行服务、模型中心和数据中心等页面能力仍按路线图实现。详细范围、任务依赖、拟修改文件和验收标准见 [`docs/local-demo-plan.md`](docs/local-demo-plan.md)，未完成项索引见 `TODO.md`。
