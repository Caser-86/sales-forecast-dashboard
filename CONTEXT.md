...
- 下一目标为本地完整演示版 V2，M1/T1、M1/T2、T3/T4/T5、T6 预测分析、T7 库存试算、T8 本地角色审批和 T9 场景/恢复已完成；T3/T5 已增加真实训练失败/重试/候选激活、完整训练跨页面一致性和训练期间 API 稳定性浏览器回归，详细路线和证据见 [`docs/local-demo-plan.md`](docs/local-demo-plan.md) 与 [`docs/local-demo-v2-acceptance-2026-09-22.md`](docs/local-demo-v2-acceptance-2026-09-22.md)。
