...
| AC-025 | Failure semantics | Partial prediction includes requested/succeeded/failed counts and prevents saving an incomplete draft | Service/API/UI tests | Partial: coverage/UI warning, disabled save state, and API save gate pass; browser evidence remains |
