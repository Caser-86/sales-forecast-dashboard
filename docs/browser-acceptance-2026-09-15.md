...
| Committed Playwright smoke in GitHub Actions | Passed | Final run [34994923588](https://github.com/Caser-86/sales-forecast-dashboard/actions/runs/34994923588) passed both committed Chromium cases: save/idempotent recovery plus export, and narrow-viewport reachability |
